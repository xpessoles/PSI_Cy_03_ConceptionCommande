% "{'classe':('PSI'),'chapitre':'slci_p','type':('td'),'titre':'Mobilité assistée à l\\'aide d\\'une canne robotisée', 'source':'Concours CCP - PSI 2018','comp':('C1-02','C2-04'),'corrige':True}"
...
\marginnote{Concours CCP -- PSI 2018.}
\marginnote[1cm]{
...
\else
\begin{marginfigure}
\includegraphics[width=\linewidth]{Abaque_tr_reduit.jpg}
\end{marginfigure}
\fi
...
%\centering
\includegraphics[width=\linewidth]{evol_hauteur_main.pdf}
...
\centering
\includegraphics[width=3cm]{Cy_03_01_TD_P_01_CanneRobotisee_qr}
\end{marginfigure}
\fi
