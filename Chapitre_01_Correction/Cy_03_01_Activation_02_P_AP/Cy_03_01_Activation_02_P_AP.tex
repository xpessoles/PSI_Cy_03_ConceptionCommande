% "{'classe':('PSI'),'chapitre':'slci_correcteurs','type':('applicatio'),'titre':'Réglage de correcteurs P et AP', 'source':'P. Dupas','comp':('C1-02','C2-04'),'corrige':True}"
...
\marginnote{\xpComp{COR}{02}\xpComp{COR}{04}}
...
\else
\begin{center}
\includegraphics[width=\linewidth]{02_exo_01_bode}
\end{center}
\fi

\question{Corriger ce système de sorte que sa marge de phase soit égale à 45\degres sans que la pulsation de coupure à \SI{0}{dB} ne soit modifiée.}
\ifprof
\begin{corrige}~\\
\begin{itemize}
...
\begin{marginfigure}
\centering
\includegraphics[width=3cm]{Cy_03_01_Activation_02_P_AP_qr}
\end{marginfigure}
\fi
