...
line([0,0.5],[1.05*0.05,1.05*0.05],'color','k','linestyle','--','LineWidth',2);
line([0,0.5],[0.95*0.05,0.95*0.05],'color','k','linestyle','--','LineWidth',2);
grid on
% yticks([0:0.1:1.6]);
% xticks([0:0.02:0.2]);
legend('P','PI','PID')
...
D=[(max(s3)-0.05)/0.05,(max(s)-0.05)/0.05,(max(s2)-0.05)/0.05];
