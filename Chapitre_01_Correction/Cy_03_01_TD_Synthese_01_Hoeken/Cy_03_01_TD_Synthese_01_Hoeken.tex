...
\subparagraph{}\textit{Justifier exhaustivement le tracé des diagrammes de Bode. Tracer le diagramme asymptotique.}
\ifprof
\begin{corrige}
\end{corrige}
\else
...
\subparagraph{}\textit{En analysant la courbe suivante, conclure sur la capacité du correcteur à valider simultanément les exigences de «~stabilité~» et de «~rapidité~».}
\ifprof
\begin{corrige}
\end{corrige}
\else
