% "{'classe':('PSI'),'chapitre':'slci_correcteurs','type':('td'),'titre':'Téléchirurgie robotisée au contact d’organes mobiles', 'source':'CCP - PSI 2015 ','comp':('C1-02','C2-04','COR-01','COR-03'),'corrige':True}"
