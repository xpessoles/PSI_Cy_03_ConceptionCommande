% "{'classe':('PSI'),'chapitre':'slci_correcteurs','type':('colle'),'titre':'Réglage d'un correcteur P et d'un correcteur à avance de phase', 'source':'Équipe PT -- La Martinière Monplaisir','comp':('C1-02','C2-04'),'corrige':True}"
...
\question{Exprimer l'erreur de trainage. }
